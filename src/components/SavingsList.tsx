  ...
  if (entries.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center min-h-[240px] flex flex-col justify-center">
        ...
        <p className="font-medium text-gray-800">No savings entries yet.</p>
        <p className="text-sm text-gray-500">Add your first savings record to start tracking progress.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-50">
        <h2 className="text-lg font-bold text-gray-800">Savings History</h2>
      </div>
